...
var NotificaContext = react.createContext(null);
...
function NotificaProvider({
  ...
  const styleInjectedRef = react.useRef(false);
  react.useEffect(() => {
...
${styles.keyframes}`;
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(NotificaContext.Provider, { value: contextValue, children: /* @__PURE__ */ jsxRuntime.jsx("div", { "data-notifica": "", "data-notifica-locale": locale, children }) });
}
function useNotifica() {
  const ctx = react.useContext(NotificaContext);
  if (!ctx) {
    throw new Error(
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "li",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.itemContent, children: [
          /* @__PURE__ */ jsxRuntime.jsx("p", { style: titleStyle, children: notification.title }),
          notification.body && /* @__PURE__ */ jsxRuntime.jsx("p", { style: styles.itemBody, children: notification.body }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "time",
            {
...
function NotificationList({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { "data-notifica-list": "", children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "ul",
      {
        role: "listbox",
        ...
        style: styles.list,
        children: notifications.map((notification) => /* @__PURE__ */ jsxRuntime.jsx(
          NotificationItem,
          {
            notification,
    ...
    hasMore && /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.loadMoreWrapper, children: /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        type: "button",
...
function SkeletonItem() {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.skeleton, "aria-hidden": "true", children: [
    /* @__PURE__ */ jsxRuntime.jsx("span", { style: styles.skeletonDot }),
    /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.skeletonContent, children: [
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.skeletonLine("70%") }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.skeletonLine("90%") }),
      /* @__PURE__ */ jsxRuntime.jsx("div", { style: styles.skeletonLine("40%") })
    ] })
  ] });
}
function LoadingSkeleton() {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { role: "status", "aria-label": "Carregando notifica\xE7\xF5es...", children: [
...
function EmptyState() {
  const { labels } = useNotifica();
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.empty, "data-notifica-empty": "", children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "svg",
      {
    ...
    /* @__PURE__ */ jsxRuntime.jsx("p", { style: styles.emptyTitle, children: labels.emptyTitle }),
    /* @__PURE__ */ jsxRuntime.jsx("p", { style: styles.emptyDescription, children: labels.emptyDescription })
  ] });
}
function NotificaInbox({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      "data-notifica-inbox": "",
      children: [
        showHeader && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: styles.inboxHeader, "data-notifica-inbox-header": "", children: [
          /* @__PURE__ */ jsxRuntime.jsx("h2", { style: styles.inboxTitle, children: labels.notifications }),
        ...
        /* @__PURE__ */ jsxRuntime.jsx("div", { style: listStyle, children: isLoading ? /* @__PURE__ */ jsxRuntime.jsx(LoadingSkeleton, {}) : notifications.length === 0 ? /* @__PURE__ */ jsxRuntime.jsx(EmptyState, {}) : /* @__PURE__ */ jsxRuntime.jsx(
          NotificationList,
          {
            notifications,
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(
          "button",
          {
            ...
            children: [
              renderIcon ? renderIcon(count) : /* @__PURE__ */ jsxRuntime.jsx(BellSVG, {}),
              renderBadge ? renderBadge(count) : /* @__PURE__ */ jsxRuntime.jsx(Badge, { count })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntime.jsx(
          Popover,
          {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(NotificaInbox, { maxHeight: 420, ...inboxProps })
          }
        )
      ]
    }
...
exports.NotificaBell = NotificaBell;
exports.NotificaInbox = NotificaInbox;
exports.NotificaProvider = NotificaProvider;
...
exports.useNotifica = useNotifica;
